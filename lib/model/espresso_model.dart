...
List<Espresso_model> espresso_model = [
  ...
  Espresso_model('2', 'assets/espresso.jpg', 'Espresso Carioca', '80ml', "O espresso carioca é um café espresso com adição de um pouco de água, resultando em uma bebida mais suave, mas ainda com o sabor característico do espresso."),
  ...
  Espresso_model('5', 'assets/', 'Macchiato', '60ml', "O macchiato é um espresso coberto com uma pequena quantidade de espuma de leite, criando uma bebida equilibrada com um toque suave de cremosidade."),
];
